              ...
              */}
                ...
                >
                  ...
                  <div className="border-l-2 border-accent/30 pl-4 py-1">
                    <p className="font-inter text-sm text-white/60 leading-relaxed font-light">
                      Building real-world applications—from integrating IoT hardware with AI object detection
                      to full-scale educational platforms—has pushed me to grow across different areas of
                      development, with a growing focus on backend architecture, data optimization, and
                      automation.
                    </p>
                  </div>
                </motion.div>
              ...
              <BentoCard className="col-span-1 row-span-3 flex flex-col p-5 md:p-6">
                ...
                <div className="flex flex-col gap-3">
                  <div className="text-[10px] md:text-xs text-white/70 font-mono flex items-center gap-2">
                  ...
                  <div className="text-[10px] md:text-xs text-white/70 font-mono flex items-center gap-2">
                    <span className="text-accent">✦</span> Mobile Apps
                  </div>
                  <div className="text-[10px] md:text-xs text-white/70 font-mono flex items-center gap-2">
                    <span className="text-accent">✦</span> AI & OCR
                  </div>
                  <div className="text-[10px] md:text-xs text-white/70 font-mono flex items-center gap-2">
              ...
              <BentoCard className="col-span-1 row-span-2 flex flex-col justify-center p-5 md:p-6">
                <span
                  className="font-mono"
                  style={{ fontSize: 9, fontWeight: 500, letterSpacing: "1.8px", textTransform: "uppercase", color: "var(--text-muted)", marginBottom: "1rem" }}
                >
                  Reach Out
                </span>
                <div className="flex flex-col gap-4">
                  <a className="flex items-center gap-3 group transition-all" href="mailto:punzalpauljohn@gmail.com">
                    ...
                    <span className="font-mono text-[10px] text-white/70 group-hover:text-accent transition-colors">
                      Email Me
                    </span>
                  </a>
              ...
              >
                <div className="flex flex-col justify-between h-full">
                  ...
                  <div
                    className="font-syne"
                    style={{ fontWeight: 800, fontSize: "clamp(20px, 2.5vw, 28px)", lineHeight: 1.1, letterSpacing: "-0.5px" }}
                  >
                    Let&apos;s build{" "}
                ...
                <span
                  style={{ display: "inline-flex", alignItems: "center", gap: 7, marginTop: 14, background: "var(--accent)", color: "#000", fontFamily: "var(--font-syne)", fontWeight: 700, fontSize: 12, letterSpacing: "0.3px", padding: "10px 24px", borderRadius: 50, transition: "all 0.2s" }}
                >
                  Get in touch ↗
                </span>
              </BentoCard>

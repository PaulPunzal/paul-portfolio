    ...
    <div className="w-full max-w-[1200px] mx-auto px-4 pb-16 pt-6 animate-in fade-in duration-700">
      ...
      <div className="flex flex-col lg:flex-row gap-4 lg:gap-6 lg:items-start">
        ...
        <div className="lg:w-[340px] shrink-0 flex flex-col gap-2 lg:sticky lg:top-28">
          ...
          {/* ── Footer note ─────────────────────────────────────────────── */}
          <p className="font-mono text-[9px] text-white/20 text-center pt-2 tracking-[1px] hidden lg:block">
              ...
              <div className="flex flex-row flex-wrap gap-2 sm:gap-3">
                {active.githubUrls.map((repo, idx) => (
                  <Link 
                    ...
                    className="flex flex-1 sm:flex-none items-center justify-center sm:justify-start gap-2 sm:gap-2.5 px-3 sm:px-4 py-2 rounded-lg bg-white/[0.03] hover:bg-white/[0.08] border border-white/[0.08] hover:border-white/[0.2] transition-all group"
                  >
                    {/* Raw SVG to prevent lucide-react compile errors */}
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5 sm:w-8 sm:h-8 text-white/20 self-center sm:self-end group-hover:text-white transition-colors shrink-0">
